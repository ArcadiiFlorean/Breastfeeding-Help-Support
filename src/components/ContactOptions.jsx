  ...
  const contacts = [
    {
      ...
      features: ["Consultații detaliate", "Programări oficiale", "Documente medicale"]
    },
    {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {contacts.map((item, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                {/* Icon */}
                <div className={`inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br ${item.bgGradient} group-hover:${item.hoverGradient} rounded-2xl shadow-xl mb-6 group-hover:scale-110 transition-all duration-300`}>
                  {item.icon}
                </div>
        ...
        {/* Trust Indicators */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center" data-aos="fade-up" data-aos-delay="500">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            ...
            <p className="text-white/80 text-sm">În maximum 24 de ore pentru toate întrebările</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            ...
            <p className="text-white/80 text-sm">Toate conversațiile sunt strict confidențiale</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            ...
            <p className="text-white/80 text-sm">Înțelegere și sprijin emoțional la fiecare pas</p>
          </div>
        </div>
      </div>
    </section>
