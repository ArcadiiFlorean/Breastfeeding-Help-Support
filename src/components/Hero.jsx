  ...
  return (
    <section className="relative bg-[#fef6f2] bg-contain bg-no-repeat bg-top tablet:bg-none overflow-hidden">
      ...
      <img
        src="/flowers-bg.jpg"
        alt="Fundal flori"
        className="hidden tablet:block absolute bottom-[80px] tablet:bottom-[100px] laptop:bottom-[100px] lg:bottom-[120px] left-1/2 -translate-x-1/2 w-full max-w-[1500px] h-auto tablet:max-h-[280px] lg:max-h-[350px] object-cover object-bottom z-0 opacity-30"
      />
...
<div className="order-1 tablet:order-2 tablet:-mt-15 laptop:mt-6 lg:mt-12 text-gray-800 max-w-3xl text-base tablet:text-[1.1rem] laptop:text-[1rem] lg:text-[1.5rem] leading-relaxed mb-10 laptop:mb-6 lg:mb-[500px]">
          <h1 className="text-3xl tablet:text-5xl mt-0 tablet:-mt-36 laptop:text-4xl lg:text-8xl font-fjalla text-[#b06b4c] leading-tight max-w-3xl pb-4">
            Sprijin profesionist pentru <span className="text-amber-900">mame</span> dedicate
          </h1>
          ...
          <p className="text-sm tablet:text-base laptop:text-sm lg:text-lg text-gray-700 mb-8 laptop:mb-6">
            Îți ofer îndrumare sigură, îngrijire adaptată nevoilor tale și susținere emoțională pentru ca tu și bebelușul tău să treceți cu încredere prin fiecare etapă a alăptării.
          </p>
