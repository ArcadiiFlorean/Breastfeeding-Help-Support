    ...
    <section className="relative bg-[#fef6f2] overflow-hidden">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 max-w-[1440px] mx-auto px-6 py-20 gap-12 items-center">
        ...
        <div className="text-gray-800 max-w-3xl text-base tablet:text-[1.1rem] lg:text-[1.5rem] leading-relaxed mb-10 lg:mb-[500px]">
          ...
          <p className="text-xl tablet:text-2xl lg:text-3xl font-semibold text-gray-900 mb-6">
            Compassionate, Certified Support for New Mothers at Every Step
          </p>

          <p className="text-sm tablet:text-base lg:text-lg text-gray-700 mb-10">
            Get expert lactation advice, personalized care, and
            confidence-boosting support to help you and your baby thrive through
        ...
        <div className="flex justify-center lg:justify-end relative">
          <img
            ...
            className="w-full max-w-[600px] tablet:max-w-[700px] lg:max-w-[1000px] h-auto object-contain z-10"
          />
        </div>
      </div>
    </section>
