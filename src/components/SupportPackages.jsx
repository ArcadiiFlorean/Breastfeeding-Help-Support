    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center px-4" data-aos="fade-up">
          <div className="bg-orange-500 rounded-2xl p-6 sm:p-8 md:p-12 text-white">
            {/* Responsive Trust Indicators */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 text-white opacity-90 text-sm sm:text-base">
